  ...
  groups: [
    {
      ...
      shapes: [
        bottleCover(),
        { ...stamp(), x: 60, y: 40, width: 200, height: 200 },
        { ...sampleChar1(), fontSize: 80, width: 80, x: 70, y: 70 },
        { ...sampleChar2(), fontSize: 80, width: 80, x: 170, y: 142 },
        { ...slogan(), x: 130, y: 200, fontSize: 40 },
        { ...label(), x: 575, y: 25 },
      ],
    },
  ],
